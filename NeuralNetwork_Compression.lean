/-!
# NeuralNetwork_Compression.lean
...
This file formalizes one interpretation of that statement using finite dynamical systems and quotient dynamics.
...
**Interpretation used in this file**: The neural network forward pass f : α → α is treated as a finite dynamical system. The MetaMap is defined as a quotient of that system by attractor equivalence, and the relationship is expressed through a semi-conjugacy.
...
The arrows correspond to formal constructions and theorems developed below. The relationship between empirical signal-geometry methods and the projection π is an interpretive hypothesis rather than a theorem of this file.
...
/-- **MetaMap**: the quotient of activation space by attractor equivalence.
    ...
    In the interpretation proposed here, a MetaMap class may be viewed as a candidate notion of concept. Two inputs belong to the
...
/-- **Neural Network as Dynamical Compression Theorem**
    ...
    **Interpretive corollary**: If signal-geometry methods approximate the projection π, then they can be viewed as estimating a mathematically defined quotient structure associated with the dynamics. -/
